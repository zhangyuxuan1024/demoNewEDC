...
<body>
	<div>
			...
			<div class="col-sm-12">
				<form class="form-horizontal" role="form">
					<div class="form-group">
						<label class="col-sm-2 control-label padding-right" for="form-field-1"">选择中心：</label>
						...
						<label class="col-sm-2 control-label padding-right" for="form-field-1">选择疑问类型：</label>
		...
		<table class="table table-striped table-bordered table-hover col-sm-12">
			<thead>
				<tr>
					<th class="col-sm-3">CRF模块</th>
					<th class="col-sm-6">疑问描述</th>
			...
			<tbody>
				...
				<tr>
					<td style="vertical-align: middle;">访视3实验室检查/十二导联心电图/影像学检查</td>
					<td>有心脏、肺脏、肝脏及肾脏功能衰竭或其他严重疾病（如脑内肿瘤、脑动静脉畸形、全身性感染、活动性的播散性血管内凝血、入组前12个月内心肌梗塞、严重精神病史）；
